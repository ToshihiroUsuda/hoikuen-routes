...
declare module 'nextjs-routes' {
  ...
  export type Route =
    | StaticRoute<'/api/mail'>
    | StaticRoute<'/contact'>
    | StaticRoute<'/'>
    | DynamicRoute<'/search/[prefecture]', { prefecture: string }>
  ...
  export type RoutedQuery<P extends Route['pathname']> = Extract<Route, { pathname: P }>['query']
...
declare module 'next/router' {
  ...
  export type NextRouter<P extends Route['pathname'] = Route['pathname']> = BaseRouter<
    PathnameAndQuery<P>
  > &
    Omit<
      Router,
